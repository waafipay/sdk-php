<?php
     ...
     */
    class InitiateHppTransactionResponseBody extends BaseResponseBody
    {
         ...
         * @return string
         */
        public function gethppRequestId()
        {
            return $this->hppRequestId;
        }

        /**
         * @param string $hppRequestId
         */
        public function sethppRequestId($hppRequestId)
        {
            $this->hppRequestId = $hppRequestId;
        }
        ...
        public function jsonSerialize()
        {
			$params = [
				 ...
				 "hppRequestId" => $this->gethppRequestId(),
			];
            return
                [
