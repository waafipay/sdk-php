<?php
     ...
     */
    class InitiateHppTransactionResponseBody implements JsonSerializable
    {
        /**
         * @var string
         */
        ...
        /**
         * @param hppResultToken $hppResultToken
         */
        ...
        public function jsonSerialize()
        {
			$serviceparam = [
                ...
                "hppResultToken" => $this->gethppResultToken(),
			];
            return
                [
