<?php
    ...
    use waafipay\pg\response\InitiateHppTransactionResponseBody;
    ...
    class Request
    {
        ...
        public static function processHpp($request, $url, $responseClassName, $readTimeout, $connTimeout)
        {
            ...
            if ($responseClassName == 'waafipay\pg\response\InitiateTransactionResponse') {
                $responseObj = new InitiateTransactionResponse([],new InitiateHppTransactionResponseBody());
            }
			...
			$hppUrl = $responseObjBody->gethppUrl();
        ...
        public static function processHppResp($request, $url, $responseClassName, $readTimeout, $connTimeout)
        {
            LoggingUtil::addLog(LogLevel::INFO, __CLASS__, "process for request: " . print_r($request, true));
            $formattedJsonReq = JSONUtil::mapToJson($request);
